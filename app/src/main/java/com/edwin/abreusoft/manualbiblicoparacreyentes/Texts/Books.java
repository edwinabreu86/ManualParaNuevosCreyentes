...
public class Books {
    ...
    public static final String[][] OT_MAJ_PROPHETS = {
            ...
            {"Jeremías", "Jeremías", "52",
                    "Profecía sobre el juicio de Dios sobre el pueblo de Judá a causa de su gran pecado y sobre la grandeza del amor divino."},
            {"Lamentaciones", "Jeremías", "5",
                    "Poemas que expresan lamento por la destrucción de Jerusalén que el profeta Jeremías había predicho."},
