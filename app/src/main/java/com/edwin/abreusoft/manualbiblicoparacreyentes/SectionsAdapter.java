...
import com.edwin.abreusoft.manualbiblicoparacreyentes.Fragments.BookFragment;
import com.edwin.abreusoft.manualbiblicoparacreyentes.Fragments.QuestionFragment;
import com.edwin.abreusoft.manualbiblicoparacreyentes.Fragments.VerseFragment;
...
class SectionsAdapter extends FragmentStatePagerAdapter {
    ...
    private final String[][] texts = new String[][]{null, null, null, null};
    ...
    public Fragment getItem(int position) {
        ...
        if (titleId == R.string.general_questions) {
            ...
            return QuestionFragment.newInstance(text0, text1);
        }
            ...
            return VerseFragment.newInstance(text0, text1, text2);
            ...
            return BookFragment.newInstance(text0, text1, text2, text3);
            }
        return null;
    }
